"""
World Bank Indicators - Aid Effectiveness -- TrendSpider store indicator by TrendSpider.

Registered as "world_bank_indicators_aid_effectiveness_TS". Translated line-for-line from the script's
published JavaScript (https://trendspider.com/trading-tools-store/indicators/6a6291-world-bank-indicators-aid-effectiveness/)
...
def script(G):
    ...
    validIndicatorIds = J.JSArray(["SH.DYN.MORT", "SE.ENR.PRSC.FM.ZS", "SE.PRM.CMPT.ZS", "SH.STA.MMRT", "SI.DST.FRST.20", "SI.POV.DDAY", "SL.EMP.VULN.ZS", "SH.STA.STNT.ZS", "SH.TBS.INCD", "SM.POP.NETM"])
    data = J.get(G_request, "http")(J.template("https://api.worldbank.org/v2/topic/2/indicator?per_page=1000&format=json"))
    ...
    G_describe_indicator(J.template("World Bank Indicators - Aid Effectiveness"), "lower", J.obj(("citation", indicatorNote), ("shortName", J.template("WBI Aid"))))
...
register_store_indicator(
    script,
    name='world_bank_indicators_aid_effectiveness_TS',
    title='World Bank Indicators - Aid Effectiveness',
    developer='TrendSpider',
    url='https://trendspider.com/trading-tools-store/indicators/6a6291-world-bank-indicators-aid-effectiveness/',
    position='lower',
    inputs=[{'id': 'indicator', 'title': 'Indicator', 'type': 'select_wide', 'default': 'Indicator SH.DYN.MORT', 'options': ['Indicator SH.DYN.MORT', 'Indicator SE.ENR.PRSC.FM.ZS', 'Indicator SE.PRM.CMPT.ZS', 'Indicator SH.STA.MMRT', 'Indicator SI.DST.FRST.20', 'Indicator SI.POV.DDAY', 'Indicator SL.EMP.VULN.ZS', 'Indicator SH.STA.STNT.ZS', 'Indicator SH.TBS.INCD', 'Indicator SM.POP.NETM']}, {'id': 'country', 'title': 'Country', 'type': 'select_wide', 'default': 'United States', 'options': ['Australia', 'Canada', 'China', 'European Union', 'Japan', 'Mexico', 'United Kingdom', 'United States', 'World']}],
    outputs=['line'],
    signals=[],
    requires=['http'],
    parity='exact',
