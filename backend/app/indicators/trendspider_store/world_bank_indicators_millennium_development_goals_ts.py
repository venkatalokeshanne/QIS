"""
World Bank Indicators - Millennium development goals -- TrendSpider store indicator by TrendSpider.

Registered as "world_bank_indicators_millennium_development_goals_TS". Translated line-for-line from the script's
published JavaScript (https://trendspider.com/trading-tools-store/indicators/6a6298-world-bank-indicators-millennium-development-goals/)
...
def script(G):
    ...
    validIndicatorIds = J.JSArray(["DC.ODA.COMM.CD", "DC.ODA.SOCL.CD", "DC.ODA.COMM.SA.CD", "DC.ODA.TLDC.CD", "DC.ODA.SOCL.ZS", "DC.ODA.TOTL.CD", "DC.ODA.UNTD.CD", "DC.ODA.TLDC.GN.ZS", "DC.ODA.TOTL.KD", "DC.ODA.TOTL.GN.ZS", "DC.ODA.UNTD.ZS", "NY.AGR.SUBS.GD.ZS", "TM.MRC.NOTX.DV.ZS", "TM.MRC.NOTX.LD.ZS", "TM.TAX.AGRI.CD.LD", "TM.TAX.AGRI.CD.DV", "TM.TAX.CLTH.CD.DV", "TM.TAX.CLTH.CD.LD", "TM.TAX.TXTL.CD.DV", "TM.TAX.TXTL.CD.LD"])
    data = J.get(G_request, "http")(J.template("https://api.worldbank.org/v2/topic/18/indicator?per_page=1000&format=json"))
    ...
    G_describe_indicator(J.template("World Bank Indicators - Millennium development goals"), "lower", J.obj(("citation", indicatorNote), ("shortName", J.template("WBI MDGs"))))
...
register_store_indicator(
    script,
    name='world_bank_indicators_millennium_development_goals_TS',
    title='World Bank Indicators - Millennium development goals',
    developer='TrendSpider',
    url='https://trendspider.com/trading-tools-store/indicators/6a6298-world-bank-indicators-millennium-development-goals/',
    position='lower',
    inputs=[{'id': 'indicator', 'title': 'Indicator', 'type': 'select_wide', 'default': 'Indicator DC.ODA.COMM.CD', 'options': ['Indicator DC.ODA.COMM.CD', 'Indicator DC.ODA.SOCL.CD', 'Indicator DC.ODA.COMM.SA.CD', 'Indicator DC.ODA.TLDC.CD', 'Indicator DC.ODA.SOCL.ZS', 'Indicator DC.ODA.TOTL.CD', 'Indicator DC.ODA.UNTD.CD', 'Indicator DC.ODA.TLDC.GN.ZS', 'Indicator DC.ODA.TOTL.KD', 'Indicator DC.ODA.TOTL.GN.ZS', 'Indicator DC.ODA.UNTD.ZS', 'Indicator NY.AGR.SUBS.GD.ZS', 'Indicator TM.MRC.NOTX.DV.ZS', 'Indicator TM.MRC.NOTX.LD.ZS', 'Indicator TM.TAX.AGRI.CD.LD', 'Indicator TM.TAX.AGRI.CD.DV', 'Indicator TM.TAX.CLTH.CD.DV', 'Indicator TM.TAX.CLTH.CD.LD', 'Indicator TM.TAX.TXTL.CD.DV', 'Indicator TM.TAX.TXTL.CD.LD']}, {'id': 'country', 'title': 'Country', 'type': 'select_wide', 'default': 'United States', 'options': ['Australia', 'Canada', 'China', 'European Union', 'Japan', 'Mexico', 'United Kingdom', 'United States', 'World']}],
    outputs=['line'],
    signals=[],
    requires=['http'],
    parity='exact',
