"""
Analyst Estimates and Consensus -- TrendSpider store indicator by TrendSpider Team.

Registered as "analyst_estimates_and_consensus_TS". Translated line-for-line from the script's
published JavaScript (https://trendspider.com/trading-tools-store/indicators/analyst-estimates-and-concensus/)
...
register_store_indicator(
    script,
    name='analyst_estimates_and_consensus_TS',
    title='Analyst Estimates and Consensus',
    developer='TrendSpider Team',
    url='https://trendspider.com/trading-tools-store/indicators/analyst-estimates-and-concensus/',
    position='lower',
    inputs=[],
