"""
ATR Support and Resistance Levels -- TrendSpider store indicator by TrendSpider Team.

Registered as "atr_support_and_resistance_levels_TS". Translated line-for-line from the script's
published JavaScript (https://trendspider.com/trading-tools-store/indicators/atr-support-and-resistance-levels/)
...
register_store_indicator(
    script,
    name='atr_support_and_resistance_levels_TS',
    title='ATR Support and Resistance Levels',
    developer='TrendSpider Team',
    url='https://trendspider.com/trading-tools-store/indicators/atr-support-and-resistance-levels/',
    position='price',
