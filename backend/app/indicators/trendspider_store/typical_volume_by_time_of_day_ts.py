"""
Typical Volume by Time of Day -- TrendSpider store indicator by TrendSpider Team.

Registered as "typical_volume_by_time_of_day_TS". Translated line-for-line from the script's
published JavaScript (https://trendspider.com/trading-tools-store/indicators/typical-volume-by-time-of-day/)
...
register_store_indicator(
    script,
    name='typical_volume_by_time_of_day_TS',
    title='Typical Volume by Time of Day',
    developer='TrendSpider Team',
    url='https://trendspider.com/trading-tools-store/indicators/typical-volume-by-time-of-day/',
    position='lower',
    inputs=[],
    outputs=[],
    signals=[],
