...
export default function SortableTh({ label, sortKey, activeKey, dir, onSort, align, style }) {
  const active = sortKey === activeKey
  return (
    <th
      className={`data-table-sortable-th${align === 'right' ? ' align-right' : ''}${active ? ' sorted' : ''}`}
